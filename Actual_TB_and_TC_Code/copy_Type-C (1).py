...
broker_address= "172.20.10.10" # Type-b broker address "172.20.10.10"
own_address= "172.20.10.9"     # Own broker address
...
client = mqttClient.Client()               # create instance for type-b
own_client = mqttClient.Client()            # create instance for self
